...
#### Вопросы:
<img src='screens/http-get.png'>
<img src='screens/http-response.png'>
1. Каков 48-разрядный Ethernet-адрес вашего компьютера?
   
   9c:30:5b:39:a0:91

   <img src='screens/http-get-eth.png'>
...
2. Какому устройству соответствует значение Ethernet-адреса?
   ...
   9c:30:5b:39:a0:91 - мой компьютер

   3c:52:a1:24:98:e7 - роутер

   <img src='screens/http-response-eth.png'>

3. Каково значение исходного Ethernet-адреса? Какое устройство имеет такой Ethernet-адрес?

   3c:52:a1:24:98:e7 - MAC-адрес роутера

4. Каков адрес назначения в этом Ethernet-кадре? Это Ethernet-адрес вашего компьютера?
   
   адрес назначения совпадает с адресом моего компьютера из задания 1
...
Я не смог добиться очистки своего ARP-кеша, поэтому выбрал ARP-запрос от роутера к моему IP.
...
1. Каковы шестнадцатеричные значения исходного и конечного адресов в Ethernet-кадре,
   ...
   3c:52:a1:24:98:e7 - исходный адрес (принадлежит роутеру)

   ff:ff:ff:ff:ff:ff - адрес назначения (broadcast)


   <img src='screens/arp-request.png'>

   

2. Содержится ли в ARP-сообщении IP-адрес отправителя?
   
   Да, в запросе этот адрес 192.168.0.1

3. Где в ARP-запросе находится сама «вопросная часть» – Ethernet-адрес той машины, чей
   соответствующий IP-адрес мы запрашиваем?
   
   Эммм, ARP по IP-адресу запрашивает MAC-адрес, а не наоборот.
   Вопросная часть (то есть IP-адрес, а вовсе не MAC-адрес) находится в поле "Target IP address"
...
4. Где в сообщении с ARP-откликом хранится Ethernet-адрес, который мы запрашивали на
   ...
   <img src='screens/arp-response.png'>
