...
Сделано:
* всё про RIP, используя потоки и сокеты (9 + 3 баллов)
...
При каждом изменении в таблице маршрутизации она выводится.
Также в конце выводятся итоговые таблицы.

<img src="screens/rip1.png">
<img src="screens/rip2.png">
